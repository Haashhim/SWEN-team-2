...
import {OrderModel} from '../../src/utils/order_model'

const MapboxDirectionsComponent = ({ initialInteger,startLat,StartLong,EndLat,EndLong }) => {
  ...
  return (<div style={{ position:"relative", width: '100%', height: '100%' }}>
    ...
    display:"flex",justifyContent:"center",alignItems:"center", borderRadius:"20px",boxShadow:"20px 10px 50px rgba(25, 62, 228, 0.192",fontSize:"1rem",
    }}>
        <h3>Total Distance: {myDistance}km</h3>
